...
def opex_summary(opex_file):
    ...
    opex_sum_transpose['Advertising & Promotions'] = opex_transpose['Biaya Pameran'] + opex_transpose['Biaya Iklan']
    ...
    aggregate_columns(opex_transpose, opex_sum_transpose, '(?i)konsultan|ahli|notaris', 'Professional Fee')
    ...
    opex_sum_transpose['Other Income/Charges tax Assets Penalty Taxes'] = opex_transpose['Biaya Pajak']+opex_transpose['Biaya Pajak STP (Surat Tagihan Pajak)']
